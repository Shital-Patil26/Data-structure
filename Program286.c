...
int main()
{
    ...
    printf("Welcome to the data structure aaplication written by Shital Patil \n");
    while(1)
    {
        printf("-----------------------------------------------\n");
        ...
        printf("9 : Terminating the application \n ");
        ...
        switch(iChoice)
        {
            ...
            case 8:
                ...
                break;
            case 9:
                printf("Thank you for using tha application \n");
                return 0;
            default:
